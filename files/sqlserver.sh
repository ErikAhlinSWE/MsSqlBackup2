...
mysqldump -h ${sql_host}   -u${sql_user} -p${sql_password} ${sql_database} --flush-logs --master-data=2 --delete-master-logs --skip-ssl | gzip >  /opt/src/${sql_database}$FILENAME.sql.gz
